...
class AppLocalizations {
  ...
  String get securitySettings => t(L10nKeys.securitySettings);
  String get mfaComingSoon => t(L10nKeys.mfaComingSoon);
  String get mfaDescription => t(L10nKeys.mfaDescription);
  String get activeDevices => t(L10nKeys.activeDevices);
  String get noDevices => t(L10nKeys.noDevices);
  String get loginHistory => t(L10nKeys.loginHistory);
  String get noLoginHistory => t(L10nKeys.noLoginHistory);
  String get retry => t(L10nKeys.retry);
  String get appearance => t(L10nKeys.appearance);
  String get themeMode => t(L10nKeys.themeMode);
  String get themeSystem => t(L10nKeys.themeSystem);
  String get themeLight => t(L10nKeys.themeLight);
  String get themeDark => t(L10nKeys.themeDark);
  String get comingSoon => t(L10nKeys.comingSoon);
...
const _en = {
  ...
  'mfaComingSoon': 'Two-factor authentication',
  'mfaDescription':
      'Add an extra layer of security to your account. Available in a future update.',
  'activeDevices': 'Active devices',
  'noDevices': 'No devices recorded yet',
  'loginHistory': 'Login history',
  'noLoginHistory': 'No login events recorded',
  'retry': 'Retry',
...
const _fr = {
  ...
  'captureTitle': 'Ajouter un reçu',
  'captureCamera': 'Prendre une photo',
  'captureGallery': 'Télécharger une image',
  'capturePdf': 'Télécharger un PDF',
  'captureManual': 'Saisir manuellement',
  'captureQr': 'Scanner un QR code',
  'captureEmail': 'Import par e-mail',
  'emailForwardingHint': 'Transférez vos reçus à votre adresse unique :',
  'reviewTitle': 'Vérifier le reçu',
  'reviewSubtitle':
      'Vérifiez et corrigez les détails extraits avant d\'enregistrer.',
  ...
  'lowConfidence': 'Faible confiance — veuillez vérifier',
  ...
  'qrScanHint': 'Pointez votre appareil photo vers le QR code du reçu',
  'qrResult': 'QR code détecté',
  'expenseCategory': 'Catégorie de dépense',
  'expenseType': 'Type de dépense',
  'personal': 'Personnel',
  'business': 'Professionnel',
  'mixedUse': 'Usage mixte',
  'businessPercentage': 'Usage professionnel',
  'suggestedCategory': 'Catégorie suggérée',
  'saveClassification': 'Enregistrer la classification',
  'classificationSaved': 'Classification enregistrée',
  'duplicateAlerts': 'Alertes de doublons',
  'noDuplicates': 'Aucun reçu en double trouvé',
  'notDuplicate': 'Pas un doublon',
  'viewReceipt': 'Voir le reçu',
  'filterByExpenseType': 'Filtrer par type de dépense',
  'allTypes': 'Tous les types',
  'insightsTitle': 'Analyses de dépenses',
  ...
  'merchantBreakdown': 'Par commerçant',
  'monthOverMonth': 'vs mois dernier',
  'spendingAlerts': 'Alertes de dépenses',
  'recurringExpenses': 'Dépenses récurrentes',
  'subscriptions': 'Abonnements possibles',
  'noInsightsData': 'Pas encore de données de dépenses',
  'noInsightsHint':
      'Ajoutez des reçus pour voir vos analyses de dépenses ici.',
  'insightsDisclaimer':
      'Ces analyses sont fournies à titre informatif uniquement.',
  ...
  'warrantiesAndReturns': 'Garanties et retours',
  'warranties': 'Garanties',
  'returns': 'Retours',
  'addWarranty': 'Ajouter une garantie',
  'addReturn': 'Enregistrer un retour',
  'warrantyDetails': 'Détails de la garantie',
  'returnDetails': 'Détails du retour',
  'warrantyPeriod': 'Période de garantie (jours)',
  ...
  'clientInvited': 'Invitation client envoyée',
  'noClients': 'Pas encore de clients',
  'noClientsHint': 'Invitez des clients à partager leurs reçus avec vous.',
  ...
  'clientReceipts': 'Reçus du client',
  'addNotes': 'Ajouter des notes',
  'accountantNotes': 'Notes du comptable',
  ...
  'notAnAccountant': 'Ce portail est réservé aux comptables.',
  'totalClients': 'Total clients',
  'pendingInvitations': 'Invitations en attente',
  'clientReceiptCount': 'Reçus',
  'scopeAllReceipts': 'Tous les reçus',
  'scopeBusinessOnly': 'Professionnel uniquement',
  'scopeTaxRelated': 'Fiscal uniquement',
  'notifications': 'Notifications',
  'notificationPreferences': 'Préférences de notification',
  'noNotifications': 'Pas encore de notifications',
  'noNotificationsHint':
      'Les alertes concernant les reçus, garanties et demandes d\'accès apparaîtront ici.',
  'markAllRead': 'Tout marquer comme lu',
  'unreadNotifications': 'Non lues',
  'pushNotifications': 'Notifications push',
  'emailNotifications': 'Notifications par e-mail',
  'smsNotifications': 'Notifications SMS',
  'warrantyReminders': 'Rappels de garantie',
  'returnReminders': 'Rappels de retour',
  'marketingNotifications': 'Actualités marketing',
  'preferencesSaved': 'Préférences enregistrées',
  'savePreferences': 'Enregistrer les préférences',
  'accountantAccessRequest': 'Demande d\'accès comptable',
  'approveAccess': 'Approuver',
  'denyAccess': 'Refuser',
  'accessApproved': 'Accès approuvé',
  'accessDenied': 'Accès refusé',
  'pendingAccountantRequests': 'Demandes comptables en attente',
  ...
  'freePlan': 'Gratuit',
  'planConsumerFree': 'Gratuit',
  'planConsumerPlus': 'Plus',
  'planConsumerPro': 'Pro',
  'featureReceiptScan': 'Scan et téléchargement de reçus',
  'featureBasicInsights': 'Analyses de dépenses de base',
  'featureAdvancedInsights': 'Analyses avancées et alertes',
  'featureWarrantyTracking': 'Suivi des garanties et retours',
  'featureExport': 'Exporter les reçus (CSV/PDF)',
  'featureAccountantSharing': 'Partage avec comptable',
  'featurePrioritySupport': 'Support prioritaire',
  'featureUnlimitedStorage': 'Stockage illimité',
  'featureUpTo25Clients': 'Jusqu\'à 25 clients',
  'featureUpTo100Clients': 'Jusqu\'à 100 clients',
  'featureUnlimitedClients': 'Clients illimités',
  'featureClientReceipts': 'Accès aux reçus clients',
  'featureClassification': 'Classification des dépenses',
  'featureTeamMembers': 'Comptes membres d\'équipe',
  'checkoutRedirect': 'Redirection vers le paiement sécurisé...',
  'subscriptionUpdated': 'Abonnement mis à jour',
  'adminDashboard': 'Tableau de bord admin',
  'navUsers': 'Utilisateurs',
  'navAccountants': 'Comptables',
  'navSupport': 'Support',
  'navAuditLogs': 'Journaux d\'audit',
  'totalUsers': 'Total utilisateurs',
  'totalConsumers': 'Consommateurs',
  'totalAccountants': 'Comptables',
  'pendingVerifications': 'Vérifications en attente',
  'openTickets': 'Tickets ouverts',
  'totalReceipts': 'Total reçus',
  'verifyAccountant': 'Vérifier',
  'rejectAccountant': 'Rejeter',
  'accountantVerified': 'Comptable vérifié',
  'accountantRejected': 'Comptable rejeté',
  ...
  'notAnAdmin': 'Ce tableau de bord est réservé aux administrateurs.',
  ...
  'mfaComingSoon': 'Authentification à deux facteurs',
  'mfaDescription':
      'Ajoutez une couche de sécurité supplémentaire. Disponible dans une prochaine mise à jour.',
  'activeDevices': 'Appareils actifs',
  'noDevices': 'Aucun appareil enregistré',
  'loginHistory': 'Historique de connexion',
  'noLoginHistory': 'Aucun événement de connexion enregistré',
  'retry': 'Réessayer',
